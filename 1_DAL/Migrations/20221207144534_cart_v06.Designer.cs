...
namespace _1_DAL.Migrations
{
    ...
    [Migration("20221207144534_cart_v06")]
    partial class cart_v06
    {
            ...
            modelBuilder.Entity("_1_DAL.Models.HoaDon", b =>
                {
                    ...
                    b.Property<Guid>("VoucherNavigrationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("VoucherNavigrationId");
            ...
            modelBuilder.Entity("_1_DAL.Models.HoaDon", b =>
                {
                    ...
                    b.HasOne("_1_DAL.Models.Voucher", "VoucherNavigration")
                        .WithMany("HoaDons")
                        .HasForeignKey("VoucherNavigrationId")
