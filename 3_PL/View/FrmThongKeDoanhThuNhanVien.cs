...
namespace _3_PL.View
{
    public partial class FrmThongKeDoanhThuNhanVien : Form
    {
        ...
        void loaddoanhthuforlocall(string ngay, string thang, string nam)
        {
            ...
            dgrid_doanhthu.Columns[2].Name = "Tổng Doanh Thu";
            dgrid_doanhthu.Rows.Clear();
            foreach (var x in _idtnvser.Getlistviewdoanhthu().Where(c => c.Ngaytt.Value.Day.ToString() == ngay && c.Ngaytt.Value.Month.ToString() == thang && c.Ngaytt.Value.Year.ToString() == nam).OrderByDescending(c => c.TongSoTien))
            {
                dgrid_doanhthu.Rows.Add(x.MaNhanVien, x.TenNhanVien, x.TongSoTien);
            }
        }
        ...
        void loaddataforlocngay(string ngay)
        {
            ...
            dgrid_doanhthu.Columns[2].Name = "Tổng Doanh Thu";
            dgrid_doanhthu.Rows.Clear();
            foreach (var x in _idtnvser.Getlistviewdoanhthu().Where(c => c.Ngaytt.Value.Day.ToString() == ngay).OrderByDescending(c => c.TongSoTien))
            {
                dgrid_doanhthu.Rows.Add(x.MaNhanVien, x.TenNhanVien, x.TongSoTien);
            }
        }
        ...
        void loaddataforlocthang(string thang)
        {
            ...
            dgrid_doanhthu.Columns[2].Name = "Tổng Doanh Thu";
            dgrid_doanhthu.Rows.Clear();
            foreach (var x in _idtnvser.Getlistviewdoanhthu().Where(c => c.Ngaytt.Value.Month.ToString() == thang).OrderByDescending(c => c.TongSoTien))
            {
                dgrid_doanhthu.Rows.Add(x.MaNhanVien, x.TenNhanVien, x.TongSoTien);
            }
        }
        ...
        void loaddataforlocnam(string nam)
        {
            ...
            dgrid_doanhthu.Columns[2].Name = "Tổng Doanh Thu";
            dgrid_doanhthu.Rows.Clear();
            foreach (var x in _idtnvser.Getlistviewdoanhthu().Where(c => c.Ngaytt.Value.Year.ToString() == nam).OrderByDescending(c => c.TongSoTien))
            {
                dgrid_doanhthu.Rows.Add(x.MaNhanVien, x.TenNhanVien, x.TongSoTien);
            }
        }
